...
/**
 * Orchestration service for the Summary Dashboard ("Meeting Ready" view).
 * AC5: Includes production line rankings.
 * AC6: Includes shipping risk alerts.
 * AC7: Includes defect trends.
 * AC8: Defaults to WEEKLY, supports DAILY and MONTHLY toggle.
 */
@Service
public class DashboardService {
    ...
    /**
     * Builds the complete dashboard summary for the given time grouping.
     * AC8: Defaults to WEEKLY if no time grouping is specified.
     * Aggregates production line rankings (AC5), shipping risk alerts (AC6),
     * and defect trends (AC7).
     *
     * @param timeGrouping the time grouping for the report (DAILY, WEEKLY, MONTHLY);
     *                     defaults to WEEKLY if null
