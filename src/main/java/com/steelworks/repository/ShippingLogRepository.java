...
/**
 * Repository for ShippingLog entity. AC3: Determines shipping status by presence of valid ship
 * date. AC6: Identifies problematic shipped batches.
 */
@Repository
public interface ShippingLogRepository extends JpaRepository<ShippingLog, Long> {
     ...
     */
    @Query("SELECT s FROM ShippingLog s " + "WHERE s.shipStatus = 'Shipped' "
