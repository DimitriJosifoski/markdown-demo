...
/**
 * Record of fulfillment and logistics.
 * AC1: One of the three data sources joined by Lot ID.
 * AC3: Presence of a valid ship date determines "Shipped" vs "In Inventory" status.
 * AC6: Used to identify "Problematic Shipped Batches."
 */
@Entity
