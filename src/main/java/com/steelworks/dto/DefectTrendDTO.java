...
/**
 * DTO for defect trend analysis. AC7: Shows if a defect type has increased or decreased in
 * frequency compared to the previous 7-day period.
 */
public class DefectTrendDTO {
    ...
    /**
     * Visual indicator for defect trend direction. AC7: Represents up/down arrow for frequency
     * change.
     */
    ...
    public long getPreviousPeriodCount() {
        return previousPeriodCount;
    }
    public void setPreviousPeriodCount(long previousPeriodCount) {
