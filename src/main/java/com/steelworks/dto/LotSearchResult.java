...
/**
 * Output DTO for lot search results.
 * AC1: Contains cross-referenced data from Production, Quality, and Shipping sources.
 * AC3: Includes computed shipping status.
 * AC9: Includes source file/location for traceability.
 */
public class LotSearchResult {
    ...
    public ShipStatus getShippingStatus() { return shippingStatus; }
    public void setShippingStatus(ShipStatus shippingStatus) { this.shippingStatus = shippingStatus; }
    ...
    public boolean isHasDataConflict() { return hasDataConflict; }
    public void setHasDataConflict(boolean hasDataConflict) { this.hasDataConflict = hasDataConflict; }
